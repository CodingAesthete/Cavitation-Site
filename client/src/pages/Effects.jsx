      ...
      <div className="p-6min-h-screen">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4 animate-slideInUp md:text-justify text-center">
            ...
            с положителен заряд, а кислородът - с отрицателен заряд. Биполярните молекули могат да се
        ...
        <section className="mb-8">
          ...
          <p className="mb-4 animate-slideInUp md:text-justify text-center">
            ...
            извори, чието начало е свързано с  от ледници. Произхождайки от границата на агрегатните
        ...
        <section className="mb-8">
          ...
          <div className="animate-slideInUp">
            ...
            <p className="mb-4 animate-slideInUp md:text-justify text-center">
              3. В зависимост от характеристиките на променената структура, течността се превръща в ефективен антиоксидант, предотвратяващ стареенето на клетките и разрушаване на ДНК.
            </p>
            <p className="mb-4 animate-slideInUp md:text-justify text-center">
