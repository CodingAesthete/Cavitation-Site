    ...
    >
      ...
      <div className="lg:flex lg:items-start mb-6">
        ...
        <div className="lg:ml-6 my-auto">
          ...
          >
            Фирма <b className='text-lg'>Vortex Shipping</b> - гр. Варна предлага комплексна система за бактериално почистване на басейни, аквариуми и както затворени, така и отворени водни пространства. Защитена е с патент <b>№ 5767</b> от 26.03.2024.
          </motion.p>
          <motion.p
            className={`mb-3 text-center sm:text-justify text-gray-700`}
            initial={{ opacity: 0 }}
      ...
      <div className="lg:flex lg:items-start lg:flex-row-reverse mb-6">
        ...
        <div className="lg:mr-6 my-auto">
          ...
          >
            Преимуществата на тази система от затворен тип се явяват в отсъствието на всякакви химически вещества, както на основата на хлора, така и всякакъв друг вид
            химически продукти.
      ...
      <div className="mt-8 flex flex-col lg:flex-row items-center">
        ...
        <motion.div>
          ...
          <p className={`text-lg leading-6 italic ${screenSize === 'sm' ? 'text-left' : 'text-justify'} text-gray-700`}>
            - търговски сделки пряко и непряко свързани с морското, речно и каботажно плаване;<br /><br />
            ...
            - еко земеделие, проектиране, производство и търговия с иновативни производствена, свързани с екосистемата;<br /><br />
            - внедряване на производствени екосистеми за пречистване на бункеровани танкерни води, пречиствателни корабни и наземни станции за пречистване на морски, баластни и отпадъчни води.
          </p>
        </motion.div>
      </div>
      ...
      <div className="mt-8" ref={sectionRef}>
        ...
        <div className="flex flex-row justify-around items-start flex-wrap">
          ...
          >
            ...
            />
            <p className="text-center text-gray-700 mt-3">Мисията на Lions Clubs International е да подобрява здравето, да подкрепя чрез хуманитарни услуги и международното разбирателство.</p>
          </motion.div>
        </div>
      </div>
    </motion.div>
